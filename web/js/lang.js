...
(function (G) {
  ...
  G.LINES_EN = {
    ...
    watchRooted: ["you do not grab the new. you return. that is rare.", "you have no garden — you have a habit. each one here is lived in."],
    watchScatter: ["you sow faster than you remember. half of it is already sky.", "beginning interests you more than staying. i do not judge — i record."],
