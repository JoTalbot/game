...
(function (G) {
    ...
    if (this.state === "play" || this.state === "birth") {
      ...
      if (being && (!node || G.dist2(this.input.wx, this.input.wy, being.x, being.y) < G.dist2(this.input.wx, this.input.wy, node.x, node.y))) {
        ...
        if (bloom) {
          ...
          if (G.Voice && bloom.verse && (!this._bloomSaid || this.time - this._bloomSaid > 3.3)) {
  ...
  G.Game.prototype.update = function (dt) {
    ...
    if (!this._skyNudged && this.state === "play" && G.Report && G.Report.acts.sky === 0 && this.world.discovered > 28 && this.time > 335 && this.world.stars.length > 4) {
      this._skyNudged = true;
      this._skyNudgedAt = this.time;
      G.Voice.say("sky");
    }
    if (!this._sigilNudged && this.state === "play" && G.Report && G.Report.acts.sigil === 0 && this.world.discovered > 22 && this.time > 495 && this._skyNudged && this.time - (this._skyNudgedAt || 0) > 90) {
