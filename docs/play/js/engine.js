...
(function (G) {
  ...
  G.Game.prototype.resize = function () {
    ...
    var w, h;
    if (window.__IGRA_PX_W && window.__IGRA_PX_H && window.__IGRA_ZOOM && window.__IGRA_ZOOM > 1.05) {
      w = Math.round(window.__IGRA_PX_W / window.__IGRA_ZOOM);
      h = Math.round(window.__IGRA_PX_H / window.__IGRA_ZOOM);
    } else if (window.__IGRA_VW && window.__IGRA_VH) {
