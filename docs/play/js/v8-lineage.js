...
(function (G) {
  ...
  function fresh(){return {version:1,generation:0,lives:0,finale:"",origin:"shore",history:[],inherited:{route:"",trait:"",worldState:"balanced",body:"shoreborn",scar:0,place:"",being:"",fingerprint:"",v4Route:"",v4Place:"",v4Being:"",v4Cause:"",v4Fingerprint:""}};}
  function read(){
    var s=fresh();
    try{
  ...
  function v4Handoff(){try{var v=G.V4SecondAct&&G.V4SecondAct.profile?G.V4SecondAct.profile():null;return v&&v.handoff?v.handoff:null;}catch(e){return null;}}
  function capture(choice,game){var s=state(),rs=G.ReleaseSystems&&G.ReleaseSystems.state?G.ReleaseSystems.state():null,v7=G.V7Climax&&G.V7Climax.profile?G.V7Climax.profile():null,b=G.V6Body&&G.V6Body.profile?G.V6Body.profile():null,r=trajectory(game),trait=ROUTE_TRAIT[r]||r||"harmony",world=v7&&v7.worldState?v7.worldState:(rs&&rs.ecology>=0.67?"flourishing":rs&&rs.ecology<=0.2?"hollow":"balanced"),body=b&&b.form||"shoreborn",scar=b?Number(b.scars||0):0,places=rs&&rs.places&&rs.places.length?rs.places[rs.places.length-1].id:"",beings=rs&&rs.beings&&rs.beings.length?rs.beings[rs.beings.length-1].id:"",generation=s.generation+1,h=v4Handoff(),v4Route=h&&h.route||"",v4Place=h&&h.place||"",v4Being=h&&h.being||"",v4Cause=h&&h.cause||"",v4Fingerprint=h&&h.fingerprint||"",fp=hash(choice+":"+r+":"+world+":"+body+":"+scar+":"+places+":"+beings+":"+generation+":"+v4Fingerprint);
    s.generation=generation;s.lives++;s.finale=choice;s.origin=choice==="become"?"voice":"shore";s.inherited={route:r,trait:trait,worldState:world,body:body,scar:Math.min(3,scar),place:places,being:beings,fingerprint:fp,v4Route:v4Route,v4Place:v4Place,v4Being:v4Being,v4Cause:v4Cause,v4Fingerprint:v4Fingerprint};s.history.push({generation:generation,finale:choice,route:r,worldState:world,body:body,fingerprint:fp,v4Route:v4Route,v4Place:v4Place,v4Being:v4Being});while(s.history.length>MAX)s.history.shift();save(s);return s;}
  function apply(game){if(!game)return false;var s=state();if(!s.generation||!s.inherited)return false;var i=s.inherited,trait=i.trait;if(game.dna&&trait&&game.dna.values&&game.dna.values[trait]!=null){game.dna.values[trait]=Math.max(game.dna.values[trait],0.16);}
    game.lineageContext={generation:s.generation,finale:s.finale,origin:s.origin,route:i.route,trait:trait,worldState:i.worldState,body:i.body,scar:i.scar,place:i.place,being:i.being,fingerprint:i.fingerprint,v4Route:i.v4Route||"",v4Place:i.v4Place||"",v4Being:i.v4Being||"",v4Cause:i.v4Cause||"",v4Fingerprint:i.v4Fingerprint||""};
    if(game.world){game.world.lineageState=i.worldState;game.world.lineageOrigin=s.origin;game.world.lineageTrace=i.fingerprint;game.world.v4LineageRoute=i.v4Route||"";game.world.v4LineagePlace=i.v4Place||"";game.world.v4LineageBeing=i.v4Being||"";game.world.v4LineageCause=i.v4Cause||"";if(game.world.nodes&&game.world.nodes.length){var n=game.world.nodes[0];n.memory=true;n.lineageTrace=i.fingerprint;n.lineageState=i.worldState;n.v4LineageRoute=i.v4Route||"";n.v4LineagePlace=i.v4Place||"";n.v4LineageCause=i.v4Cause||"";if(i.scar>0)n.scars=Math.max(Number(n.scars)||0,i.scar);}}
    if(game.player){game.player.lineageGeneration=s.generation;game.player.lineageTrait=trait||"";game.player.lineageOrigin=s.origin;game.player.v4LineageBeing=i.v4Being||"";game.player.v4LineagePlace=i.v4Place||"";}
    return true;
  }
