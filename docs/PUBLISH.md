...
| Политика конфиденциальности | `docs/PRIVACY.md` | готово, требует финальной сверки с APK |
...
Технический RC artifact уже выпущен, а физический RC gate закрыт.
...
Актуально для **v3.0.1 / versionCode 601**. Последнее обновление: 14 сентября 2026.
