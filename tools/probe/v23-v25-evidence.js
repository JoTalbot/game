...
console.log(JSON.stringify({schema:"evidence-v2",status:production.status,rc2:rc2.ready,limitedRelease:limited.ready,production:production.ready,passed:production.evidence.passed,missing:production.missing,blockers:production.blockers,physicalAndroid:production.evidence.physicalAndroidVerified}));
