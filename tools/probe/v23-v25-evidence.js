...
assert.deepStrictEqual(production.missing,[],"production evidence has no missing gates"); assert.deepStrictEqual(production.blockers,[],"production evidence has no blockers");
