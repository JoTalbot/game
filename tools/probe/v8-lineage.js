...
const g=H.makeWorld(G,7000);g.state="play";g.time=1500;const rs=G.ReleaseSystems.state();rs.act=3;rs.ecology=0.82;setTrait(g,"empathy",0.9);G.V6Body.observe(g);G.V7Climax.choose("release",g);G.V8Lineage.capture("release",g);
...
G.Save.set("igra.v8-lineage.v1",JSON.stringify({version:999,generation:999,lives:999,history:"bad",inherited:null}));G.V8Lineage._s=null;const migrated=G.V8Lineage.profile();ok(migrated.version===1&&migrated.generation===999&&migrated.history.length===0,"lineage migration repairs invalid history");ok(migrated.inherited&&typeof migrated.inherited==="object","lineage migration restores inherited envelope");
