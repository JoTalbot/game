...
var candidates = [
  { id: "echo", setup: 0.2, consequence: 0.2, rarity: 0.1 },
  { id: "awakening", setup: 0.9, consequence: 0.9, rarity: 1.0 },
  { id: "quiet", setup: 0.1, consequence: 0.1, rarity: 0.1 }
];
var first = G.V14Director2.choose(world, candidates);
assert.strictEqual(first.id, "awakening", "director selects highest-scoring novel consequence");
