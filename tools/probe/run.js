...
(function () {
  ...
  ok(/порог срыва 96/.test(gtext), "видно, насколько уезжал палец",
...
(function () {
  var game = H.makeWorld(G, 7);
  G.Report.reset();
  // босс прямо на игроке — кусает 38/с
  game.world.boss = {
  ...
  ok(G.Report.drain.boss > 30, "босс попадает в разбивку расхода силы",
     "съедено " + Math.round(G.Report.drain.boss) + " за секунду (реально 38)");
  ok(G.Report.lowest <= 70, "падение силы под боссом видно в отчёте",
